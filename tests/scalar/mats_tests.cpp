...
TEST(scalar_layout, add_matrixes) {
...
#pragma region BMAT2x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Bool, 2, 3, 24);
	EXPECT_EQ(*base, *tempType);
...
#pragma region IMAT2x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Int, 2, 3, 24);
	EXPECT_EQ(*base, *tempType);
...
#pragma region UMAT2x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Uint, 2, 3, 24);
	EXPECT_EQ(*base, *tempType);
...
#pragma region MAT2x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Float, 2, 3, 24);
	EXPECT_EQ(*base, *tempType);
...
#pragma region DMAT2x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Double, 2, 3, 48);
	EXPECT_EQ(*base, *tempType);
...
#pragma region UMAT3x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Uint, 3, 3, 36);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Uint"), 36);
	EXPECT_EQ(structLayout.get_array_count("Uint"), 3);
#pragma endregion
...
#pragma region DMAT3x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Double, 3, 3, 72);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Double"), 72);
	EXPECT_EQ(structLayout.get_array_count("Double"), 3);
#pragma endregion
#pragma endregion
...
#pragma region UMAT4x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Uint, 4, 3, 48);
	EXPECT_EQ(*base, *tempType);
...
#pragma region DMAT4x3
	...
	tempType = std::make_shared<mat_type>(ValueType::Double, 4, 3, 96);
	EXPECT_EQ(*base, *tempType);
...
TEST(scalar_layout, add_marixes_array) {
	scalar_layout structLayout;
...
#pragma region BMAT2x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Bool, 2, 3, 24, 2, 48);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Bools"), 48);
	EXPECT_EQ(structLayout.get_array_count("Bools"), 2);
#pragma endregion
...
#pragma region IMAT2x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Int, 2, 3, 24, 2, 48);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Ints"), 48);
	EXPECT_EQ(structLayout.get_array_count("Ints"), 2);
#pragma endregion
...
#pragma region UMAT2x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Uint, 2, 3, 24, 2, 48);
	EXPECT_EQ(*base, *tempType);
...
#pragma region MAT2x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Float, 2, 3, 24, 2, 48);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Floats"), 48);
	EXPECT_EQ(structLayout.get_array_count("Floats"), 2);
#pragma endregion
...
#pragma region DMAT2x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Double, 2, 3, 48, 2, 96);
	EXPECT_EQ(*base, *tempType);
...
#pragma region UMAT3x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Uint, 3, 3, 36, 2, 72);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Uints"), 72);
	EXPECT_EQ(structLayout.get_array_count("Uints"), 2);
#pragma endregion
...
#pragma region DMAT3x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Double, 3, 3, 72, 2, 144);
	EXPECT_EQ(*base, *tempType);
	...
	EXPECT_EQ(structLayout.get_size("Doubles"), 144);
	EXPECT_EQ(structLayout.get_array_count("Doubles"), 2);
#pragma endregion
#pragma endregion
...
#pragma region UMAT4x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Uint, 4, 3, 48, 2, 96);
	EXPECT_EQ(*base, *tempType);
...
#pragma region DMAT4x3_ARRAY
	...
	tempType = std::make_shared<array_type>(ValueType::Double, 4, 3, 96, 2, 192);
	EXPECT_EQ(*base, *tempType);
