...
TEST(scalar_layout, add_vectors) {
...
TEST(scalar_layout, add_vectors_array) {
	scalar_layout structLayout;
...
#pragma region BVEC3_ARRAY
	...
	temp_type = std::make_shared<array_type>(ValueType::Bool, 3, 12, 2, 24);
	EXPECT_EQ(*base, *temp_type);
...
#pragma region IVEC3_ARRAY
	...
	temp_type = std::make_shared<array_type>(ValueType::Int, 3, 12, 2, 24);
	EXPECT_EQ(*base, *temp_type);
...
#pragma region UVEC3_ARRAY
	...
	temp_type = std::make_shared<array_type>(ValueType::Uint, 3, 12, 2, 24);
	EXPECT_EQ(*base, *temp_type);
...
#pragma region VEC3_ARRAY
	...
	temp_type = std::make_shared<array_type>(ValueType::Float, 3, 12, 2, 24);
	EXPECT_EQ(*base, *temp_type);
...
#pragma region DVEC3_ARRAY
	...
	temp_type = std::make_shared<array_type>(ValueType::Double, 3, 24, 2, 48);
	EXPECT_EQ(*base, *temp_type);
	...
	EXPECT_EQ(structLayout.get_size("Doubles"), 48);
	EXPECT_EQ(structLayout.get_array_count("Doubles"), 2);
#pragma endregion
#pragma endregion
