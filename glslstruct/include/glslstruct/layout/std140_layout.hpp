...
#pragma once
#ifndef _GLSL_STRUCT_STD140_LAYOUT_HPP_
	#define _GLSL_STRUCT_STD140_LAYOUT_HPP_
...
namespace glslstruct {
	namespace utils {
		template<class T>
		static _GLSL_STRUCT_CONSTEXPR17 const bool is_glsl_std140_value_type_v =
		  utils::is_glsl_simple_v<T> || utils::is_glsl_std140_layout_v<T>;
