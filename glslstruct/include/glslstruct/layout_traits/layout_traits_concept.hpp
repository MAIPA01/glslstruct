...
namespace glslstruct {
		// GET ALIGNMENT
		// get_scalar_alignment(const ValueType type, opt ctx&) -> size_t;
		// get_vec_alignment(const ValueType type, const size_t length, opt ctx&) -> size_t;
		// get_array_alignment(const size_t elemBaseAlignment, opt ctx&) -> size_t;
		// get_struct_alignment(opt ctx&) -> size_t;

		// BEFORE ADD
		// before_add(size_t& currentOffset, opt ctx&) -> void;
		// before_add_scalar(size_t& currentOffset, opt ctx&) -> void;
		// before_add_vec(size_t& currentOffset, opt ctx&) -> void;
		// before_add_mat(size_t& currentOffset, opt ctx&) -> void;
		// before_add_array(size_t& currentOffset, opt ctx&) -> void;
		// before_add_struct(size_t& currentOffset, opt ctx&) -> void;

		// AFTER ADD
		// after_add(size_t& currentOffset, const size_t size, const size_t alignment, opt ctx&) -> void;
		// after_add_scalar(size_t& currentOffset, const size_t size, const size_t alignment, opt ctx&) -> void;
		// after_add_vec(size_t& currentOffset, const size_t size, const size_t alignment, opt ctx&) -> void;
		// after_add_mat(size_t& currentOffset, const size_t size, const size_t alignment, opt ctx&) -> void;
		// after_add_array(size_t& currentOffset, const size_t size, const size_t alignment, opt ctx&) -> void;
		// after_add_struct(size_t& currentOffset, const size_t size, const size_t alignment, opt ctx&) -> void;
