...
ValueType vec_type::get_type() const noexcept {
	return _type;
}
size_t vec_type::get_length() const noexcept {
	return _length;
}

std::string vec_type::to_string() const noexcept {
	return fmt::format("{}{}", vec_type_to_string(_type), _length);
}
